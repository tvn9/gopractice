...
func main() {
	...
	// Convert CLI-argument to float64
	...
	// msg variable holds the earthquake magnitude's rating
	var msg string

	// matching num reading with msg rating
	switch num {
	case 0.5:
		msg = "micro"
	case 2.5:
	...
	fmt.Printf("Earthquake magnitude of %.2f is %s\n", num, msg)
}
